export const styles = {
  ...
  variants: {
    default: {
      select:
        'border-gray-300 bg-white text-gray-900 focus:border-sky-500 focus:ring-sky-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-sky-400',
      disabled:
    ...
    warning: {
      select:
        'border-orange-300 bg-white text-gray-900 focus:border-orange-500 focus:ring-orange-300 dark:border-orange-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-orange-400',
      disabled:
    ...
    info: {
      select:
        'border-sky-300 bg-white text-gray-900 focus:border-sky-500 focus:ring-sky-300 dark:border-sky-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-sky-400',
      disabled:
  ...
  optionSelected: 'bg-sky-100 dark:bg-sky-900',
