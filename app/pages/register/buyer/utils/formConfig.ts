...
export const createBuyerFormFields = (isEdit = false): FormFieldConfig[] => [
  {
    name: 'name',
    type: 'input',
    ...
    helperText: 'Nome da empresa compradora',
  },

  {
    ...
    inputConfig: {
      type: 'email',
      placeholder: 'Ex: compras@frigorificocentral.com.br',
      maxLength: 100,
    },
...

  {
    ...
    helperText: 'Status do comprador',
  },
...
export const createBuyerFormConfig = (isEdit = false) => ({
  title: '',
  description: '',
  layout: 'grid' as const,
  gridColumns: 3,
  submitButtonText: isEdit ? 'Salvar Alterações' : 'Cadastrar Comprador',
  resetButtonText: isEdit ? 'Restaurar Valores' : 'Limpar Formulário',
  showResetButton: true,
});

export const getInitialValues = (): Omit<Buyer, 'id' | 'createdAt' | 'deletedAt'> => ({
  name: '',
  email: '',
  phone: '',
  street: '',
