...
export const createSupplierFormFields = (isEdit = false): FormFieldConfig[] => [
  {
    name: 'name',
    type: 'input',
    ...
    inputConfig: {
      type: 'text',
      placeholder: 'Ex: AgroFornecedores Ltda',
      maxLength: 100,
    },
    ...
    helperText: 'Nome da empresa fornecedora',
  },

  {
    ...
    inputConfig: {
      type: 'email',
      placeholder: 'Ex: vendas@agrofornecedores.com.br',
      maxLength: 100,
    },
...

  {
    ...
    helperText: 'Status do fornecedor',
  },
...
export const createSupplierFormConfig = (isEdit = false) => ({
  title: '',
  description: '',
...
export const getInitialValues = (): Omit<Supplier, 'id' | 'createdAt' | 'deletedAt'> => ({
  name: '',
  email: '',
  phone: '',
  street: '',
