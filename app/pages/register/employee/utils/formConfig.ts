...
export const createEmployeeFormFields = (isEdit = false): FormFieldConfig[] => [
  {
    name: 'name',
    type: 'input',
    label: 'Nome Completo',
...

  {
    ...
    helperText: 'Email de contato do colaborador',
  },
  {
    name: 'phone',
    type: 'input',
...

  {
    ...
    helperText: 'Status do colaborador',
  },
...
export const createEmployeeFormConfig = (isEdit = false) => ({
  title: '',
  description: '',
  layout: 'grid' as const,
  gridColumns: 3,
  submitButtonText: isEdit ? 'Salvar Alterações' : 'Cadastrar Colaborador',
  resetButtonText: isEdit ? 'Restaurar Valores' : 'Limpar Formulário',
  showResetButton: true,
});

export const getInitialValues = (): Omit<Employee, 'id' | 'createdAt' | 'deletedAt'> => ({
  name: '',
  email: '',
  phone: '',
  street: '',
