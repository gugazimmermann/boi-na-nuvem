...
interface ObservationActionsProps {
  ...
  onEdit: (observation: LocationObservation) => void;
  onDelete: (observation: LocationObservation) => void;
}

export const ObservationActions = memo<ObservationActionsProps>(
  ({ observation, onEdit, onDelete }) => {
...
ObservationActions.displayName = 'ObservationActions';
